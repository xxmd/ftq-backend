...
public class SubscriptionIdValidator implements ConstraintValidator<ValidSubscriptionId, Long> {

    @Autowired
    private SubscriptionRepository subscriptionRepository;

    @Override
    public boolean isValid(Long subscriptionId, ConstraintValidatorContext context) {
